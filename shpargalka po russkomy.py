...
async def process_start_command(message: types.Message):
    ...
    buttons = ["морфологический","морфемный","разбор существительного","разбор глагола","разбор прилагательного","o vi iz angliy"]
...
@dp.message_handler(lambda message: message.text == "разбор существительного")
async def with_puree(message: types.Message):
    await message.reply("Начальная форма \n Постоянные признаки:собственное/нарицательное,одушевленное/неодушевленное,род,склонение.\n Непостоянные признаки:падеж,число.\nРоль в предложении.")

@dp.message_handler(lambda message: message.text == "o vi iz angliy")
async def with_puree(message: types.Message):
    await message.reply("noy inglish iagvdzh yet :<")
